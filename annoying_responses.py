...
class Annoying_response:
    ...
    def __init__(self):
        ...
        user_input = self.convertUserVoiceToText(audio, r)
    ...
    def convertUserVoiceToText(self, audio_file, r):
        try:
            return("Google Speech Recognition thinks you said " + r.recognize_google(audio_file))
